...
export default {
  ...
  <div class="w-100" style="max-width: 400px;">
    <h1 class="text-center mb-4">Sign In as an Influencer</h1>
    <form @submit.prevent="loginInfluencer" class="p-4 border rounded bg-light">
      <div class="mb-3">
    ...
    <p class="text-center pt-3">
      ...
      <RouterLink to="/influencer/register" class="text-decoration-none">Register</RouterLink>
    </p>
  </div>
</div>
  `,
